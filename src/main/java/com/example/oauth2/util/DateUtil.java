...
public class DateUtil extends DateUtils {
	...
	private static final String[] parsePatterns = new String[] { "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm", "yyyyMMdd",
	        "yyyy-MM-dd", "yyyy-MM", "HH:mm", "MM/dd/yyyy HH:mm:ss", "MM/dd/yyyy"
	...
	* 判断是否是昨天的某个时间
	 ...
	 * @return
	 */
	public static Long timeBetween(Date early, Date late, int type) {
		long v = 1L;
		switch (type) {
		...
		return ((late.getTime() - early.getTime()) / v);
	}
